...
public class SelectPurchaseViewController: BaseTableAdapterController, SwipeableNavigation {
    ...
    public override func viewDidAppear(_ animated: Bool) {
        ...
        //DecibelSDK.shared.set(screen: "SelectPurchaseViewController")
    }
    ...
    override public var state: [TableComponent] {
        return [
            ...
            .calculatableContainer(state: [.centeredImageWithCalculatableSpace(image: imageProvider.selectPurchaseTypeIcon)]),
            ...
            .buttonWithSubtitle(title: LS("PaidAccount.SelectPurchase.PayForOne"),
                                subtitle: "FOR \(Int(PurchasePrice.single.rawValue)) ESS",
            ...
            .buttonWithSubtitle(title: LS("PaidAccount.SelectPurchase.PayForUnlimited"),
                                subtitle: "FOR \(Int(PurchasePrice.unlimited.rawValue)) ESS",
