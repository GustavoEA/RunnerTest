...
class DeleteAccountViewController: BaseTableAdapterController {
    ...
    override func viewDidAppear(_ animated: Bool) {
        ...
        //DecibelSDK.shared.set(screen: "DeleteAccountViewController")
    }
    ...
    func viewUserState(_ user: ViewUser) -> [TableComponent] {
        ...
        return
            [.imageTitleRightImage(image: icon, title: user.name, imageS: imageProvider.greyCancel, action: { [unowned self] in
