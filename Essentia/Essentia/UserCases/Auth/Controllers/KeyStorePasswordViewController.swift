...
class KeyStorePasswordViewController: BaseTableAdapterController, UIDocumentPickerDelegate, SwipeableNavigation {
    ...
    override func viewDidAppear(_ animated: Bool) {
        ...
        //DecibelSDK.shared.set(screen: "KeyStorePasswordViewController")
    }
    ...
    private func showFilePicker() {
        let fileBrowser = UIDocumentPickerViewController(documentTypes: ["public.data", "public.item"], in: .open)
